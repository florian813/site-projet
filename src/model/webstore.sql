...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 29 avr. 2021 à 12:57
...
(12, 'florian', 'leborgne', 'florianleborgne813@gmail.com', '123456'),
(14, 'Jean Eude', 'Dupont', 'Jean@gmail.com', 'jean123456');
...
INSERT INTO `comment` (`id`, `content`, `date`, `id_product`, `id_account`) VALUES
(7, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur eleifend libero ut tristique efficitur. Suspendisse finibus risus vel lacinia auctor. Proin hendrerit semper auctor. Vestibulum fermentum semper malesuada. Nulla hendrerit leo ac diam bibendum pellentesque. Nullam tincidunt vestibulum augue vel blandit. Mauris eu fermentum nunc, nec ullamcorper mauris. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Suspendisse tincidunt, nibh vel vehicula rhoncus, quam ex bibendum ligula, et molestie justo dui sit amet erat. Morbi convallis rhoncus ligula, eget viverra augue lobortis eget.', '2021-04-22', 1, 14),
(8, 'Phasellus tempor neque non elit iaculis, vitae bibendum mi mollis. Nulla efficitur, mi sit amet sodales gravida, urna quam cursus mi, id euismod urna enim a nulla. Phasellus vitae neque id diam imperdiet tincidunt. Nulla efficitur, tortor id laoreet cursus, metus tellus sodales urna, ut malesuada urna ex at urna. Sed elit ante, maximus ac neque eget, luctus vehicula massa. In facilisis ut velit sed interdum. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut eget placerat est, non facilisis quam. Nam purus lacus, fermentum ut auctor in, condimentum pretium tellus. Donec consequat justo mi, vel pellentesque elit convallis a.', '2021-04-22', 7, 14),
(9, 'In tempus, sapien blandit porta aliquam, velit quam vestibulum eros, id lacinia nibh tortor ut velit. Quisque eget ullamcorper lorem. Nullam non consectetur ligula. Proin sit amet neque consectetur, volutpat mi non, interdum dui. Quisque et hendrerit massa. Duis tortor lorem, vulputate fermentum tristique non, efficitur id neque. Sed ut posuere leo, ut sollicitudin arcu. Donec interdum congue erat, in vulputate sapien eleifend in. Quisque vehicula eget eros a hendrerit.', '2021-04-22', 3, 12),
(10, 'Morbi neque felis, tincidunt at hendrerit at, tincidunt sed tellus. Integer aliquet sodales lectus, quis ullamcorper neque congue eu. Etiam pulvinar auctor lectus a tempor. Nullam posuere euismod pretium. Integer bibendum suscipit justo vitae sodales. Vivamus sed eros ut diam aliquet pellentesque. Praesent ut dapibus metus, et commodo enim. Sed sollicitudin, nisl id molestie euismod, libero ex interdum eros, vitae tempor felis mi ac justo. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Sed sed pretium tellus. Ut iaculis tellus non est fringilla eleifend. Donec non elit orci. Mauris aliquet ultricies ex, a rutrum justo gravida sed. Fusce sit amet rutrum tortor. Pellentesque eget ipsum porta, elementum risus nec, elementum ipsum. Mauris non facilisis arcu, id condimentum ex.', '2021-04-22', 5, 12),
(11, 'très bon produit ! je recommandes :)', '2021-04-22', 5, 14);
...
--
ALTER TABLE `comment`
  ADD CONSTRAINT `fk_account` FOREIGN KEY (`id_account`) REFERENCES `account` (`id`),
